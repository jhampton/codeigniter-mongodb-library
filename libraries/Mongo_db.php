...
class Mongo_db
{
	...
	*/
	...
	{		
		// Allow full connection string to be passed by the config (for PHPFog/AppFog/Environment-variable-based configuration)
		if (!isset($this->_config_data['mongo_connectionstring'])) {
			...
			// Use the config connection string
			$this->_connection_string = trim($this->_config_data['mongo_connectionstring']);
		}
